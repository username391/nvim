...
-- Устанавливаем пакеты. Пакетный менеджер - lazy.nvim
require("lazy").setup({
    -- Просто для теста, потом возможно удалю этот пакет
    {
    ...
    -- это для подсветки синтаксиса
    {
        "nvim-treesitter/nvim-treesitter"
    },

    -- поиск файлов в выпадающем окне
    {
    ...
    { "neovim/nvim-lspconfig" }, -- нужен установленный nodejs

    -- автодополнение
    --{ "hrsh7th/nvim-cmp" },
    --{ "hrsh7th/cmp-nvim-lsp" },
    --{ "L3MON4D3/LuaSnip" }, -- сниппеты для Lua (или не только, хуй поймешь)
