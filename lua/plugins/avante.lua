...
M.build = vim.fn.has("win32") ~= 0 and "powershell -ExecutionPolicy Bypass -File Build.ps1 -BuildFromSource false"
	or "make"
...
M.opts = {
	...
	providers = {
		openrouter = {
			...
			-- 	["HTTP-Referer"] = "https://yourdomain.example", -- требуется OpenRouter
